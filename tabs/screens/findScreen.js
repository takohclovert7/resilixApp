...
import PermissionsScreen from '../../components/permission/permission';
import { getLocation } from "../../getLocation"
import FineScreenStart from './findScreenStart';
import NetInfo from '@react-native-community/netinfo';

const  FineScreen= ({ navigation}) => {
  ...
  const reloadScreen = () => {
    navigation.navigate('Find', { key: Math.random() });
  };
...
//location manipulation end
  ...
  return (<>
<FineScreenStart  location={locationDate}  reloadScreen={reloadScreen}/>
   </>
  )
}
