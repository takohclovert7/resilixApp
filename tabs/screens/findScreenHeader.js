...
<Image 
                  ...
                  <View style={{  backgroundColor: "rgba(0,113,206,0.15)", alignItems: "center", borderRadius: 10, flexDirection: "row" ,padding:10,paddingLeft:0}}>
                            <Image
...
<View style={{marginLeft:15,marginTop:30, width: 354, backgroundColor: "rgba(0,113,206,0.21)", height: 41, alignItems: "center",  flexDirection: "row",justifyContent:"space-between" }}>
