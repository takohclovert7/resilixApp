...
import NotificationMainScreen  from "../notificationComp/notificationMain"
const  NotificationStartScreen = ({navigation }) => {
  ...
  const reloadScreen = () => {
    navigation.navigate('Notification', { key: Math.random() });
  };
...
//location manipulation end
  ...
  return ( <>
<NotificationMainScreen  handleSendAlert={handleSendAlert}  addressName={addressName}/> 
   </>
  )
}

export default NotificationStartScreen;
