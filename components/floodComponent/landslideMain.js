...
import LandSlideStatistics from './landSlideStatistics';

const LandSlideMainComp = ({ navigation }) => {
...
//location manipulation end
 ...
 navigation.navigate('Screen3',{addressName:RouteData,boldText:boldText,emegencyDreciption:inputValue})
  ...
  return (<>
 <LandSlideStatistics   location={locationDate}  />
   </>
  )
}

export default LandSlideMainComp;