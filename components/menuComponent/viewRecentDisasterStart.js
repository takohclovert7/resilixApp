...
import ViewRecentDisasters from './viewRecentDisaster';
import NetInfo from '@react-native-community/netinfo';

const ViewRecentDisastersStart = ({ navigation }) => {
...
//location manipulation end
  ...
  return (<>
<ViewRecentDisasters  location={locationDate}  navigation={navigation} />
   </>
  )
}

export default  ViewRecentDisastersStart;