...
import PredictFlood from './predictFload';

const  PredictFloodStatistic = ({ route, navigation }) => {
  
function handleFloodPerdayRoute(RouteData){
  navigation.navigate('Screen7',{RouteData:RouteData});
...
//location manipulation end
  ...
  return (<>
<PredictFlood handleFloodPerdayRoute={handleFloodPerdayRoute}  location={locationDate} />
   </>
  )
}

    
export default PredictFloodStatistic;
